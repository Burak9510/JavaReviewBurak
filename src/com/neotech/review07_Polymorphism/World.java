...
public class World {
	...
	public static void main(String[] args) {
	 ...
	 // Declaring a variable of type Human
	    ...
	    System.out.println("Lets us make people talk, by giving money :) ");
	    h1.talk();
	    h2.talk();
	    h3.talk();
	    h4.talk();
	   ...
	   Human h5 = (Human) us1; // up-casting, implicitly
	   h5.talk();
	   
	   American us2 = (American) h5; // down-casting, explicity
	   us2.taxReturn();
